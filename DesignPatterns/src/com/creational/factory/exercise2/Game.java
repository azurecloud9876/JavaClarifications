...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        Mario test = new Mario("test");
        Scanner scanner = new Scanner(System.in);

        System.out.printf("Game On.%nYou are playing using[%s]. Jump Attach is [%d] and Mushroom is [%d]%n", test.getName(), test.getJumpAttack(), test.getMushroomAttack());
